                    ...
                    case JsonTokenType.PropertyName:
                        ...
                        switch (propertyName)
                        {
                            ...
                            case "data":
                                ...
                                {
                                    var typeInfo = _options.GetTypeInfo(typeof(PackageSearchMetadata)) as System.Text.Json.Serialization.Metadata.JsonTypeInfo<PackageSearchMetadata>;
                                    var searchResult = JsonSerializer.Deserialize(ref reader, typeInfo);
